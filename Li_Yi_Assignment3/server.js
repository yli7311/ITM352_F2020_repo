...
var user_qty_str = ""; //to be updated; stores user the post url of selected quantities
...
app.post("/process_register", function (request, response) {
    ...
    if (users_reg_data[request.body.username.match] != 'undefined') {
    ...
    if (request.body.name.match(name_rgx), request.body.email.match(email_rgx),request.body.username.match(username_rgx),request.body.password.match(password_rgx),request.body.passwordrepeat == request.body.password, typeof users_reg_data[request.body.username] == 'undefined'){
        username = request.body.username.toLowerCase(); //makes username case blind
